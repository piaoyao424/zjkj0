...
public final class TypeTransform {
	...
	public static int byteArrayLHToInt(byte[] b, int offset) {
		return ((b[3 + offset] & 0xff) << 24) | ((b[2 + offset] & 0xff) << 16) | ((b[1 + offset] & 0xff) << 8) | ((b[offset] & 0xff) << 0);
	}
	...
	public static int byteArrayHLToInt(byte[] b, int offset) {
		return ((b[offset] & 0xff) << 24) | ((b[1 + offset] & 0xff) << 16) | ((b[2 + offset] & 0xff) << 8) | ((b[3 + offset] & 0xff) << 0);
	}
